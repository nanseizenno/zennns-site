...
description: "介绍 TPCA 状态迁移前置控制架构及其工程节点 PCN。围绕明确的目标状态入口，将相关状态按预先定义的 C / A / E 状态映射关系组织，并通过 S / D / B 判定、控制仲裁、多路径控制、状态迁移判定履历和 PCN 网络形成连续的工程结构。"
date: 2026-07-01
lastmod: 2026-09-25
author: "全野南政 / Nansei Zenno"
document_type: "公开白皮书"
version: "Public Version 1.7"
...
| 3 | **PCN** | 获取相关状态并调用当前入口预先定义的 C / A / E 状态映射关系 | 整理状态变量域 |
...
| 目标状态入口 | 本次前置判定对应哪个入口 |
| 相关状态 | 与本次状态迁移直接有关的状态 |
| C / A / E 状态映射关系 | 在设计或配置阶段，按当前目标状态入口预先定义各相关状态的工程作用 |
| S / D / B 判定 | 对相关状态执行的判定 |
