...
很多现场系统能稳定运行，正是因为工程师靠经验把大量隐含条件补上了。
...
项目规模较小时，经验丰富的工程师可以靠记忆和理解把这些内容串起来。
...
状态迁移设计长期依赖个人经验，并不是因为现场没有控制逻辑，而是因为控制逻辑缺少统一的状态迁移表达方式。
...
很多老工程师能快速判断问题，是因为他在脑中已经隐含完成了这些区分。
