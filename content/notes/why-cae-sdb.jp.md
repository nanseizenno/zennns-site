...
summary: "明確な目標状態入口の前において、C / A / E が状態遷移に関係する状態の役割を三つの状態変数領域として整理し、S / D / B が各状態を構造完全性、動的時系列有効性、制御境界の観点から判定する理由を説明する。二つの軸を分けることで、どの状態変数領域で、どの判定特性に関する結果が確認されたかを共通形式で表現できる。"
