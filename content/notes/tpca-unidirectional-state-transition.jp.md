...
### 4.4 状態モデル全体を一つの時間方向で記述できる

正常処理、異常処理、Recovery、Retry などを、過去の State Instance へ逆向きに戻る遷移として扱わず、すべて後続する State Instance への遷移として記述することで、状態モデル全体を一つの時間方向で整理できる。
